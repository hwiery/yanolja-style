...
const CategoryItem: React.FC<CategoryItemProps> = React.memo(({ imageSrc, label }) => {
  return (
...
const CategoryNavigation: React.FC = () => {
  return (
    <nav aria-label="카테고리 내비게이션">
      <div className="flex flex-wrap justify-center gap-4 mt-6 w-full text-xs leading-none text-center text-zinc-900">
      ...
      <div className="flex flex-wrap justify-center gap-4 mt-4 w-full text-xs leading-none text-center text-zinc-900">
